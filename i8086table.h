...
static const i8086_Inst_Table i8086_inst_table[] = {
    ...
    { 0x70, Mneumonic_jo, "Jb", NULL, Instruction_Type_jump },
    { 0x71, Mneumonic_jno, "Jb", NULL, Instruction_Type_jump },
    { 0x72, Mneumonic_jb, "Jb", NULL, Instruction_Type_jump },
    { 0x73, Mneumonic_jnb, "Jb", NULL, Instruction_Type_jump },
    { 0x74, Mneumonic_jz, "Jb", NULL, Instruction_Type_jump },
    { 0x75, Mneumonic_jnz, "Jb", NULL, Instruction_Type_jump },
    { 0x76, Mneumonic_jbe, "Jb", NULL, Instruction_Type_jump },
    { 0x77, Mneumonic_ja, "Jb", NULL, Instruction_Type_jump },
    { 0x78, Mneumonic_js, "Jb", NULL, Instruction_Type_jump },
    { 0x79, Mneumonic_jns, "Jb", NULL, Instruction_Type_jump },
    { 0x7A, Mneumonic_jp, "Jb", NULL, Instruction_Type_jump },
    { 0x7B, Mneumonic_jnp, "Jb", NULL, Instruction_Type_jump },
    { 0x7C, Mneumonic_jl, "Jb", NULL, Instruction_Type_jump },
    { 0x7D, Mneumonic_jnl, "Jb", NULL, Instruction_Type_jump },
    { 0x7E, Mneumonic_jle, "Jb", NULL, Instruction_Type_jump },
    { 0x7F, Mneumonic_jg, "Jb", NULL, Instruction_Type_jump },
    ...
    { 0xE0, Mneumonic_loopnz, "Jb", NULL, Instruction_Type_jump },
    { 0xE1, Mneumonic_loopz, "Jb", NULL, Instruction_Type_jump },
    { 0xE2, Mneumonic_loop, "Jb", NULL, Instruction_Type_jump },
    { 0xE3, Mneumonic_jcxz, "Jb", NULL, Instruction_Type_jump },
    ...
    { 0xE9, Mneumonic_jmp, "Jv", NULL, Instruction_Type_jump },
    { 0xEA, Mneumonic_jmp, "Ap", NULL, Instruction_Type_jump },
    { 0xEB, Mneumonic_jmp, "Jb", NULL, Instruction_Type_jump },
